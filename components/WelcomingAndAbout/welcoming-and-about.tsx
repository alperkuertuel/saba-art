...
export default function WelcomingAbout() {
  return (
    <WelcomingSection>
      <StyledWelcomingText>Hallo und herzlich willkommen in meiner online Kunst-Galerie!</StyledWelcomingText>
      <StyledAvatarContainer>
        <StyledAvatar priority={true} width={192} height={200} src="/img/saba-art.jpg" alt="Saba" />

        <StyledLink target="_blank" href="https://www.instagram.com/sezenkansu/" rel="noopener noreferrer">
          Foto: @sezenkansu
        </StyledLink>
      </StyledAvatarContainer>
      ...
      <StyledAboutParagraph>
        Die Bilder in der Galerie werden regelmäßig aktualisiert, es lohnt sich also öfter mal vorbeizuschauen.
      </StyledAboutParagraph>
    </WelcomingSection>
  );
}
