  ...
  return (
    <>
      ...
      <CarouselWrapper>
        ...
        >
          <a href={`/documents/auszug_allgemein.pdf`} target="_blank" rel="noopener noreferrer">
            <StyledImage
            ...
            />
            <StyledLegend>
              Auszug aus meinem Gästebuch, welches zu allen meinen Ausstellungen ausliegt. Das Zitat{" "}
              <q>Erfolg ist so einsam und eiskalt wie der Nordpol</q> deutet darauf hin, dass der
              Weg zum Erfolg oft von Isolation und emotionaler Kälte begleitet wird, da die
              Herausforderungen und Opfer, die für den Erfolg erforderlich sind, eine persönliche
